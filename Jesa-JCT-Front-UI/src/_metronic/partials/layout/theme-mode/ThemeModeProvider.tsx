...
export type ThemeModeType = "dark" | "light" | "dark_blue" | "dark_gradient" | "system";
...
const getThemeModeFromLocalStorage = (lsKey: string): ThemeModeType => {
	...
	if (data === "dark" || data === "light" || data === "dark_blue" || data === "dark_gradient" || data === "system") {
		return data as ThemeModeType;
	}
	...
	if (document.documentElement.hasAttribute("data-bs-theme")) {
		...
		if (
			dataTheme &&
			(dataTheme === "dark" || dataTheme === "light" || dataTheme === "dark_blue" || dataTheme === "dark_gradient" || dataTheme === "system")
		) {
			return dataTheme as ThemeModeType;
		}
	}
